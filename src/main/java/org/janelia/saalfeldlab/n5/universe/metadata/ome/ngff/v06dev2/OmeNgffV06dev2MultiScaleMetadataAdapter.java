...
public class OmeNgffV06dev2MultiScaleMetadataAdapter implements JsonDeserializer< OmeNgffV06dev2MultiScaleMetadata >, JsonSerializer< OmeNgffV06dev2MultiScaleMetadata > {

	@Override
	public OmeNgffV06dev2MultiScaleMetadata deserialize( final JsonElement json, final Type typeOfT, final JsonDeserializationContext context ) throws JsonParseException {
		...
		final OmeNgffV06dev2Dataset[] datasets = context.deserialize(jobj.get("datasets"), OmeNgffV06dev2Dataset[].class);
		...
		for( OmeNgffV06dev2Dataset dataset : datasets )
			SpacesTransforms.synchronize( dataset.coordinateTransformations, coordinateSystems );

		return new OmeNgffV06dev2MultiScaleMetadata(nd, "", name, type, coordinateSystems, datasets, null,
				coordinateTransformations, metadata, false);
	}

	@Override
	public JsonElement serialize( final OmeNgffV06dev2MultiScaleMetadata src, final Type typeOfSrc, final JsonSerializationContext context )
	{
