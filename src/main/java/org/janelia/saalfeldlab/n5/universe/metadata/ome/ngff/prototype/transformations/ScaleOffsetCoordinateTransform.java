...
public class ScaleOffsetCoordinateTransform {
//extends AbstractLinearCoordinateTransform<double[][]> {
...
//
//	public ScaleOffsetCoordinateTransform(final double[] scale, final double[] offset) {
//		super("scale_offset");
//		this.scale = scale;
//		this.offset = offset;
...
//	}
//
//	public ScaleOffsetCoordinateTransform(final N5Reader n5, final String path) {
//		super("scale_offset", path);
//		double[][] p = getParameters(n5);
//		buildTransform(p);
//	}
//
//	public ScaleOffsetCoordinateTransform(final String path) {
//		super("scale_offset", path);
//		this.scale = null;
//		this.offset = null;
//	}
