...
public class OmeNgffV06dev2MetadataParser implements N5MetadataParser<OmeNgffV06dev2MultiScaleMetadata>, N5MetadataWriter<OmeNgffV06dev2MultiScaleMetadata> {

	final static String VERSION = "0.6-dev2";

	private final Gson gson;

	protected final boolean assumeChildren;

	public OmeNgffV06dev2MetadataParser(final boolean assumeChildren) {

		gson = gsonBuilder().create();
		this.assumeChildren = assumeChildren;
	}

	public OmeNgffV06dev2MetadataParser() {
	...
	@Override
	public Optional<OmeNgffV06dev2MultiScaleMetadata> parseMetadata(final N5Reader n5, final N5TreeNode node) {

		final OmeNgffV06dev2MultiScaleMetadata multiscales = parse( n5, node.getPath());
		if (multiscales == null )
		...
		final NgffV06SingleScaleAxesMetadata[] msChildrenMeta = OmeNgffV06dev2MultiScaleMetadata.buildMetadata(nd,
				node.getPath(),
		...
		return Optional.of(new OmeNgffV06dev2MultiScaleMetadata(multiscales, msChildrenMeta));
	}	
	
	private OmeNgffV06dev2MultiScaleMetadata parse(N5Reader n5, final String dset) {

		try {
			final JsonElement elem = n5.getAttribute(dset, "ome/multiscales", JsonElement.class);
			final OmeNgffV06dev2MultiScaleMetadata meta = gson.fromJson(elem, OmeNgffV06dev2MultiScaleMetadata.class);

			return new OmeNgffV06dev2MultiScaleMetadata(
					meta.getAxes().length,
					dset,
					meta.getName(),
					meta.type,
	...
	@Override
	public void writeMetadata(final OmeNgffV06dev2MultiScaleMetadata t, final N5Writer n5, final String groupPath) throws Exception {
