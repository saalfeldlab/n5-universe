...
import org.janelia.saalfeldlab.n5.universe.metadata.ome.ngff.v06.graph.CoordinateSystems;
...
public class SpacesTransforms {
	...
	public static boolean synchronize( final CoordinateTransform<?> ct, final CoordinateSystems coordinateSystems ) {
		...
		final CoordinateSystem inputCs = coordinateSystems.getSpace( ct.getInput().getName() );
		final CoordinateSystem outputCs = coordinateSystems.getSpace( ct.getOutput().getName() );
